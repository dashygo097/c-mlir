...
inline auto sub(mlir::OpBuilder &builder, mlir::Location loc,
...
inline auto neg(mlir::OpBuilder &builder, mlir::Location loc,
                       mlir::Value value) -> mlir::Value {
...
inline auto andi(mlir::OpBuilder &builder, mlir::Location loc,
                        mlir::Value lhs, mlir::Value rhs) -> mlir::Value {
  return emitIntOp<mlir::arith::AndIOp>(builder, loc, lhs, rhs);
}

inline auto ori(mlir::OpBuilder &builder, mlir::Location loc,
                       mlir::Value lhs, mlir::Value rhs) -> mlir::Value {
  return emitIntOp<mlir::arith::OrIOp>(builder, loc, lhs, rhs);
}

inline auto xori(mlir::OpBuilder &builder, mlir::Location loc,
                        mlir::Value lhs, mlir::Value rhs) -> mlir::Value {
