...
# Function to add MLIR-based executable
function(add_mlir_executable name)
...
# Function to add MLIR-based library
function(add_mlir_library name)
  add_library(${name} ${ARGN})
  
  # Link against core MLIR libraries
...
# Function to generate MLIR dialect tablegen files
function(add_mlir_dialect_tablegen output_file)
  cmake_parse_arguments(ARG "" "DIALECT" "DEPENDS" ${ARGN})
  
  set(LLVM_TARGET_DEFINITIONS ${ARG_DIALECT}.td)
  mlir_tablegen(${output_file} ${ARGN})
  add_public_tablegen_target(${output_file}Gen)
endfunction()
